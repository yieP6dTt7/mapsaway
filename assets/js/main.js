...
let mixerPortfolio = mixitup('.service__container', {
    selectors: {
        target: '.service__card'
    },
    animation: {
        duration: 300
    }
...
sr.reveal(`.home__handle, .home__img`, {delay: 900, origin: 'bottom'})
sr.reveal(`.news, .service, .procon, .team, .contact`, {delay: 1000, origin: 'bottom'})